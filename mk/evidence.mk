...
venus-probe-2d:
	python3 scripts/venus_probe.py --arch "$(ARCH)" --mode 2d --qemu "$(QEMU)" --timeout "$(RUN_TIMEOUT)"

venus-probe-ring:
	python3 scripts/venus_probe.py --arch "$(ARCH)" --mode venus-ring --qemu "$(QEMU)" --timeout "$(RUN_TIMEOUT)"
