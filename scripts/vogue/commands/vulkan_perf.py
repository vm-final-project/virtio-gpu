...
Usage:
    python3 python3 -m scripts.vogue evaluate vulkan [--repetitions N] [--allow-blocked]
"""
...
from ..core.artifacts import blocked_artifact, make_artifact, write_json
...
def main() -> int:
    ...
    if status.startswith("blocked:"):
        data = blocked_artifact(
            source="python3 -m scripts.vogue evaluate vulkan",
            status=status,
