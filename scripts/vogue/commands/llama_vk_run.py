...
This replaces the previous non-invasive stub in python3 -m scripts.vogue capture vk-bench
...
def _emit(status: str, *, log_tail: str = "", extra: dict | None = None,
    ...
    base = {
        ...
        "run_log": "results/llama/llama_vk.log",
        "claim_allowed": (
    ...
    # (see python3 -m scripts.vogue evaluate matrix:_uk_runtime_status). Written only when the
