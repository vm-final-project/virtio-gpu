...
def main() -> int:
    ...
    app=load(ROOT/"results/app_perf_latest.json")
    venus=load(ROOT/"results/venus/venus_perf_latest.json")
    qemu=load(ROOT/"results/venus/qemu_2d_probe_latest.json")
    rows=[]
    ...
    (OUT/"benchmark_summary_latest.json").write_text(json.dumps(payload, indent=2)+"\n")
    with (OUT/"benchmark_summary_latest.csv").open("w", newline="") as f:
    ...
    (OUT/"benchmark_summary_latest.md").write_text("\n".join(md)+"\n")
