...
```json
{
  "status": "blocked:ring-or-frame-proof-missing",
  "mode": "venus-ring",
  "returncode": 0,
  "elapsed_s": 5.67883825302124,
  "qemu_command": [
  ...
  "frame_proof": {
    ...
    "variance_check": "fail",
    "status": "blocked:flat-screendump",
    ...
    "written_at": "2026-06-01T08:14:13Z"
  },
  "first_missing_dependency": "Frame proof status is blocked:flat-screendump.",
