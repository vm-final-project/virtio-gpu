...
```json
{
  ...
  "qemu_command": [
    ...
    "stdio",
    "-qmp",
    "unix:/mydata/JerryT/virtio-gpu/results/kmscube_vgpu_gl/run/.qmp/qmp.sock,server=on,wait=off",
    "-device",
    "virtio-gpu-gl-pci,id=vgpu0,hostmem=512M,blob=true,venus=true",
    "-kernel",
  ...
  "frame_proof": {
    ...
    "maxval": 255,
    "bytes": 3072000,
    "sha256": "56407cbda8c895498929324e5efbf0ddb1d1cf82befdd69959b00a905dcc0c63",
