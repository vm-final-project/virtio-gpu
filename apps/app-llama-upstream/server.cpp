 ...
 *
 * Built when CONFIG_APP_LLAMA_UPSTREAM_MODE_SERVER=y. The image boots, loads
...
#if CONFIG_APP_LLAMA_UPSTREAM_MODE_SERVER

#ifndef CONFIG_APP_LLAMA_UPSTREAM_PARALLEL
#define CONFIG_APP_LLAMA_UPSTREAM_PARALLEL 1
#endif
#ifndef CONFIG_APP_LLAMA_UPSTREAM_PROMPT_CACHE
#define CONFIG_APP_LLAMA_UPSTREAM_PROMPT_CACHE 1
#endif
...
int main(void)
{
    ...
    constexpr int n_slots = CONFIG_APP_LLAMA_UPSTREAM_PARALLEL;
    llama_context *slots[n_slots] = {nullptr};

    llama_context_params cparams = llama_context_default_params();
    cparams.n_ctx           = 512;
    cparams.n_batch         = 128;
    cparams.n_threads       = CONFIG_APP_LLAMA_UPSTREAM_THREADS;
    cparams.n_threads_batch = CONFIG_APP_LLAMA_UPSTREAM_THREADS;
...
#endif /* CONFIG_APP_LLAMA_UPSTREAM_MODE_SERVER */
