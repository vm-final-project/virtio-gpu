 ...
 *
 * Built when CONFIG_APP_LLAMA_UPSTREAM_MODE_BENCH=y. The image boots, mounts
...
#if CONFIG_APP_LLAMA_UPSTREAM_MODE_BENCH
...
#endif /* CONFIG_APP_LLAMA_UPSTREAM_MODE_BENCH */
