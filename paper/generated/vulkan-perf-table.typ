...
#figure(
  text(size: 8pt, table(
    ...
    [Map latency (llvmpipe)], [`21 µs avg`], [Host-coherent memory map+write+unmap],
    [Fence latency (llvmpipe)], [`19 µs avg`], [Empty cmd submit + vkWaitForFences],
    ...
    [Venus ring substrate], [`pass`], [host-visible blob copy 13848.88 MiB/s in native fake backend],
