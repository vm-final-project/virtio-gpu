...
#figure(
  text(size: 8pt, table(
    ...
    [Map latency (llvmpipe)], [`53 µs avg`], [Host-coherent memory map+write+unmap],
    [Fence latency (llvmpipe)], [`48 µs avg`], [Empty cmd submit + vkWaitForFences],
    ...
    [Venus ring substrate], [`pass`], [host-visible blob copy 5719.78 MiB/s in native fake backend],
