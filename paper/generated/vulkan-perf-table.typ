...
#figure(
  text(size: 8pt, table(
    ...
    [Fence latency (llvmpipe)], [`24 µs avg`], [Empty cmd submit + vkWaitForFences],
    ...
    [Venus ring substrate], [`pass`], [host-visible blob copy 5861.39 MiB/s in native fake backend],
