...
#figure(
  text(size: 8pt, table(
    ...
    [Fence latency (llvmpipe)], [`29 µs avg`], [Empty cmd submit + vkWaitForFences],
    ...
    [Venus ring substrate], [`pass`], [host-visible blob copy 10582.46 MiB/s in native fake backend],
