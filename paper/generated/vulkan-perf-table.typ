...
#figure(
  text(size: 8pt, table(
    ...
    [Fence latency (llvmpipe)], [`27 µs avg`], [Empty cmd submit + vkWaitForFences],
    ...
    [Venus ring substrate], [`pass`], [host-visible blob copy 9317.23 MiB/s in native fake backend],
